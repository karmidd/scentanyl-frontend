...
export default function BrandCard({brand}){
    ...
    return (
        <div
            ...
            className={`cursor-pointer ${theme.card.primary} ${theme.text.primary} border border-gray-700 rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-5 lg:p-6 xl:p-7 ${theme.border.hover} transition-all duration-300 hover:shadow-lg ${theme.shadow.button} hover:scale-105 transform group relative overflow-hidden`}
        >
            ...
            <div className="relative z-10 flex flex-col">
                ...
                <div className="text-center mb-2 sm:mb-3">
                    <h3 className={`text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-bold ${theme.text.groupHover} transition-colors duration-300 capitalize leading-tight line-clamp-2`}>
                        {brand.name}
                    </h3>
                </div>
                ...
                {brand.country && (
                    <div className="flex items-center justify-center space-x-2 mb-3 sm:mb-4">
                        ...
                        <h2 className={`text-xs sm:text-sm md:text-base lg:text-lg font-medium ${theme.text.secondary} ${theme.text.groupHover} transition-colors duration-300 capitalize line-clamp-1`}>
                            {brand.country}
                        </h2>
                    </div>
                )}
