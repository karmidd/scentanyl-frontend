            ...
            <div className="relative z-10 font-['Viaoda_Libre',serif] text-base sm:text-lg md:text-xl lg:text-2xl">
                <div className={theme.text.primary}>
                    ...
                    <main className="mt-5 max-w-6xl mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-6 md:py-8 pt-[80px] sm:pt-[100px] md:pt-[160px]">
                        ...
                        <div className="space-y-4 sm:space-y-6 md:space-y-8 mb-8 sm:mb-12 md:mb-16">
                            <div className="space-y-3 sm:space-y-4 md:space-y-6">
                                <BlurText
                                    ...
                                    animateBy="words"
                                    direction="top"
                                    className="flex justify-center text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-white font-bold leading-tight text-center px-2"
                                />
                                <BlurText
                            ...
                            {/* Search Bar */}
                            <form onSubmit={handleSearch} className="max-w-xs sm:max-w-lg md:max-w-xl lg:max-w-2xl mx-auto px-2">
                                <div className="relative group">
                                    <input
                                        ...
                                        className={`
                                            w-full px-3 sm:px-4 md:px-6 lg:px-8 py-3 sm:py-4 md:py-5 lg:py-6 
                                            text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl 
                                            ${theme.bg.input} ${theme.border.primary} ${theme.text.primary}
                                            border rounded-xl sm:rounded-2xl focus:outline-none focus:border-blue-400 
                                    ...
                                    <button
                                        ...
                                        className={`
                                            ...
                                            ${theme.button.primary} p-2 sm:p-3 md:p-4 rounded-lg sm:rounded-xl 
                            ...
                            {/* Quick Actions */}
                            <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 md:gap-6 justify-center pt-4 sm:pt-6 md:pt-8 px-2">
                                <BrowseAllButton/>
                                <RandomFragranceButton
                                    text={"Random Discovery"}
                                    className={`cursor-pointer group relative inline-flex items-center justify-center px-4 sm:px-6 md:px-8 py-3 sm:py-4 text-base sm:text-lg md:text-xl font-bold ${theme.text.primary} bg-gradient-to-r ${theme.randomDiscoveryButton.primary} rounded-lg sm:rounded-xl shadow-2xl hover:shadow-gray-500/25 transition-all duration-300 hover:scale-105 transform hover:-translate-y-1 border border-gray-500/30`}
                                />
                            </div>
                        </div>
                        ...
                        {/* Call to Action */}
                        <div className="text-center space-y-3 sm:space-y-4 md:space-y-6 pt-8 sm:pt-12 md:pt-16 px-2">
                            <BlurText
                                text="Ready to Start Your Fragrance Journey?"
                                delay={300}
                                animateBy="words"
                                direction="bottom"
                                className={`flex justify-center text-xl sm:text-2xl md:text-3xl font-bold text-white`}
                            />
                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center">
                                <button
                                    onClick={() => navigate('/collection')}
                                    className={`${theme.button.primary} font-semibold py-3 sm:py-4 px-6 sm:px-8 rounded-lg sm:rounded-xl transition-all duration-300 hover:scale-105 text-base sm:text-lg md:text-xl`}
                                >
                                    Build Your Collection
                                </button>
                                <button
                                    onClick={() => navigate('/wishlist')}
                                    className={`${theme.button.secondary} font-semibold py-3 sm:py-4 px-6 sm:px-8 rounded-lg sm:rounded-xl transition-all duration-300 hover:scale-105 text-base sm:text-lg md:text-xl`}
                                >
                                    Create Wishlist
                                </button>
                            </div>
