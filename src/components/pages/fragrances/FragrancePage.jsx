            ...
            <div className="text-center space-y-4 sm:space-y-6 md:space-y-8">
                ...
                <div className="space-y-3 sm:space-y-4 md:space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-1">
                        ...
                        <span className={`px-3 sm:px-4 py-1.5 sm:py-2 ${fragrance.gender === "men" ? "bg-blue-800" : fragrance.gender === "women" ? "bg-pink-600" : "bg-gradient-to-r from-pink-600 via-purple-500 to-blue-800"} rounded-full text-sm sm:text-base md:text-lg lg:text-xl font-medium mt-2 sm:mt-0 sm:ml-2`}>
                                        <BlurText
